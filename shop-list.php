		...
		<div class="col-md-3 pr-0">
			<div class="card rounded-0">
                ...
                <ul class="list-group rounded-0 category_block">
                    <a href="#"><li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center rounded-0">Apple<span class="badge badge-danger badge-pill">2</span></li></a>
                    <a href="#"><li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center rounded-0">Iphone<span class="badge badge-danger badge-pill">2</span></li></a>
                    <a href="#"><li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center rounded-0">Samsung<span class="badge badge-danger badge-pill">2</span></li></a>
                    <a href="#"><li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center rounded-0">Huawei<span class="badge badge-danger badge-pill">2</span></li></a>
                </ul>
            </div>
		</div>
		...
		<div class="col-md-9">
			<div class="row">
				...
				<div class="col-md-12">
					<ul class="list-group">
                <!-- list group item-->
                 <a href=""><li class="list-group-item list-group-item-action rounded-0">
                    <!-- Custom content-->
